...
import { getUserCache, getUserFromDb, prisma, type UserCacheData, type UserDBData } from "./prisma";
...
type CustomJWT = JWT & { discordSnowflake?: string, cache?: UserCacheData, dbData?: UserDBData };
export type CustomSession = AdapterSession & { user?: AdapterUser & { id?: string; data?: UserDBData; cache?: UserCacheData; } };
