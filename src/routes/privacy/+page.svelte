<h2 id="title" style="text-align: center;"><b>PRIVACY POLICY</b></h2>
<p>Effective date: 2024-06-29</p>
<p>1. <b>Introduction</b></p>
<p>Welcome to <b> Cata</b>.</p>
<p>
	<b>Cata</b> (“us”, “we”, or “our”) operates <b>kaikibot.xyz</b> (hereinafter referred to as
	<b>“Service”</b>).
</p>
<p>
	Our Privacy Policy governs your visit to <b>kaikibot.xyz</b>, and explains how we collect,
...
<p><b>SERVICE</b> means the kaikibot.xyz website operated by Cata.</p>
<p>
...
<p>
	<b>USAGE DATA</b> is data collected automatically either generated by the use of Service or from
...
<p>
	<b>DATA CONTROLLER</b> means a natural or legal person who (either alone or jointly or in common
	with other persons) determines the purposes for which and the manner in which any personal data are,
	or are to be, processed. For the purpose of this Privacy Policy, we are a Data Controller of your
	data.
</p>
<p>
	<b>DATA PROCESSORS (OR SERVICE PROVIDERS)</b> means any natural or legal person who processes the
...
<p>
	...
	you access Service by or through any device (<b>“Usage Data”</b>).
</p>
<p>
...
<p>Cata uses the collected data for various purposes:</p>
...
<p>
	0.10. to provide you with notices about your account and/or subscription, including expiration
...
<p>
	If you are located outside United States of America and choose to provide information to us,
	please note that we transfer the data, including Personal Data, to United States of America and
	process it there.
</p>
<p>
...
<p>
	Cata will take all the steps reasonably necessary to ensure that your data is treated securely
...
<p>
	0.2.7. if we believe disclosure is necessary or appropriate to protect the rights, property, or
...
<p>
	...
	from our systems, please email us at <b>cata@cata.moe</b>.
</p>
...
<p>
	0.2. our Privacy Policy link includes the word “Privacy”, and can easily be found on the home
	page of our website;
</p>
<p>0.3. users will be notified of any privacy policy changes on our Privacy Policy Page;</p>
<p>
	0.4. users are able to change their personal information by emailing us at <b>cata@cata.moe</b>.
</p>
...
<p>
	<b
		...
		your Personal Data and can request disclosure or deletion at any time.</b
	>
</p>
<p>
