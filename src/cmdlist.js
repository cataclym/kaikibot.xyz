  ...
  commands: [
    [
      ...
      [
        ...
        },
        {
          ...
          description:
            "Deletes one or more channels. Also deletes categories and voice channels.",
        },
        {
          id: "nsfwtgl",
    ...
    [
      ...
      [
        ...
        },
        {
          ...
          userPermissions: "",
          description:
            "Returns a random reddit post, from a specified subreddit.",
        },
        {
          id: "tictactoe",
    ...
    [
      ...
      [
        ...
        {
          id: "rolecreate",
          aliases: ["createrole", "rolecreate", "cr", "rc"],
          channel: "guild",
          ownerOnly: false,
          usage: "GAMERS",
        ...
        {
          id: "rolehoist",
          aliases: ["hoistrole", "rolehoist", "hoist"],
          channel: "guild",
          ownerOnly: false,
          usage: "@gamers",
          userPermissions: "MANAGE_ROLES",
        ...
        {
          id: "rolementionable",
          aliases: ["rolementionable", "mentionable", "rolem"],
          channel: "guild",
          ownerOnly: false,
          usage: "@gamers",
          userPermissions: "MANAGE_ROLES",
        ...
        {
          id: "roleremove",
          aliases: ["removerole", "roleremove", "rr"],
          channel: "guild",
          ownerOnly: false,
          usage: "@Dreb Gamer",
          userPermissions: "MANAGE_ROLES",
    ...
    [
      ...
      [
        ...
        },
        {
          ...
          userPermissions: "MANAGE_CHANNELS",
          description:
            "Exclude or include a channel from dadbot. Provide no parameter to show a list of excluded channels. ",
        },
        {
        ...
        },
        {
          ...
          userPermissions: "MANAGE_GUILD",
          description:
            "Tests goodbye message as it would appear when triggered.",
        },
        {
          id: "listreacts",
        ...
        },
        {
          ...
          userPermissions: "MANAGE_GUILD",
          description:
            "Tests welcome message as it would appear for new members.",
        },
      ],
    ],
    [
      ...
      [
        ...
        {
          id: "cmdlist",
          aliases: ["commands", "cmdlist", "cmds"],
          channel: null,
          ownerOnly: false,
          usage: ["", "admin"],
          userPermissions: "",
          description:
            "Shows categories, or commands if provided with a category.",
        },
        {
          id: "color",
          aliases: ["color", "clr"],
          ...
          userPermissions: "",
          description:
            "Returns a representation of a color string, or shows list of available color names to use.",
        },
        {
          id: "colorlist",
          aliases: ["colorlist"],
        ...
        {
          id: "exclude",
          aliases: ["exclude", "excl", "e"],
          channel: "guild",
          ownerOnly: false,
          userPermissions: "",
          description:
            "Adds or removes excluded role from user. Excludes the user from being targeted by dad-bot.",
        },
        {
          id: "fetch",
          aliases: ["fetch", "fu"],
        ...
        },
        {
          ...
          userPermissions: "",
          description:
            "Returns info on a channel, role, member, emoji, or message",
        },
        {
          id: "invite",
          aliases: ["invite", "inv"],
